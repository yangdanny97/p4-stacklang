...
def main(p4info_file_path, bmv2_file_path, topo_file_path):
    ...
    try:
        ...
        addForwardingRule('s1', '10.0.4.44', 4)
        addForwardingRule('s1', '10.0.5.55', 4)
        addForwardingRule('s1', '10.0.6.66', 4)
        addForwardingRule('s1', '10.0.7.77', 5)
        addForwardingRule('s1', '10.0.8.88', 5)
        addForwardingRule('s1', '10.0.9.99', 5)
        addForwardingRule('s2', '10.0.1.11', 4)
        addForwardingRule('s2', '10.0.2.22', 4)
        addForwardingRule('s2', '10.0.3.33', 4)
        addForwardingRule('s2', '10.0.4.44', 1)
        addForwardingRule('s2', '10.0.5.55', 2)
        addForwardingRule('s2', '10.0.6.66', 3)
        addForwardingRule('s2', '10.0.7.77', 5)
        addForwardingRule('s2', '10.0.8.88', 5)
        addForwardingRule('s2', '10.0.9.99', 5)
        addForwardingRule('s3', '10.0.1.11', 4)
        addForwardingRule('s3', '10.0.2.22', 4)
        addForwardingRule('s3', '10.0.3.33', 4)
        addForwardingRule('s3', '10.0.4.44', 5)
        addForwardingRule('s3', '10.0.5.55', 5)
        addForwardingRule('s3', '10.0.6.66', 5)
        addForwardingRule('s3', '10.0.7.77', 1)
        addForwardingRule('s3', '10.0.8.88', 2)
        addForwardingRule('s3', '10.0.9.99', 3)
